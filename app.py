...
API = " http://192.168.29.120:5000 "

MODEL_PATH = f'Breast-Cancer-Predictor-with-Scikit-Learn-Streamlit-and-Deployed-with-Flask-and-AWS-main/model/lr_model.pkl'
SCALER_PATH = f'Breast-Cancer-Predictor-with-Scikit-Learn-Streamlit-and-Deployed-with-Flask-and-AWS-main/model/scaler.pkl'
IMG_SIDEBAR_PATH = "Breast-Cancer-Predictor-with-Scikit-Learn-Streamlit-and-Deployed-with-Flask-and-AWS-main/assets/img.jpg"
BGR_PATH = "Breast-Cancer-Predictor-with-Scikit-Learn-Streamlit-and-Deployed-with-Flask-and-AWS-main/assets/background.png"
...
def get_clean_data():
  data = pd.read_csv("Breast-Cancer-Predictor-with-Scikit-Learn-Streamlit-and-Deployed-with-Flask-and-AWS-main/dataset/data.csv")
...
def main() :  
    ...
    with open("Breast-Cancer-Predictor-with-Scikit-Learn-Streamlit-and-Deployed-with-Flask-and-AWS-main/assets/style.css") as f:
    ...
    df = pd.read_csv("Breast-Cancer-Predictor-with-Scikit-Learn-Streamlit-and-Deployed-with-Flask-and-AWS-main/dataset/chart_tumor_diagnosed.csv")
